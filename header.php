...
<html lang="en">
    ...
    <head>
        ...
        <link href="http://demo.phpjabbers.com/1486537505_357/index.php?controller=pjFront&action=pjActionLoadCss&layout=layout7" type="text/css" rel="stylesheet" />
                    ...
                    <div class="col-md-12">
                        <div class="text-center visible-lg">
                            <ul id="hornavmenu" class="nav navbar-nav">
                                ...
                                <li><a href="about-user.php" class="fa-user activ+e">My Profile</a>                                </li>
                                <li><a href="allauthors.php" class="fa-group active">Authors</a>
                                <li>
                                    <span class=" fa-key fa-font ">Login/Sign Up</span>
                                    <ul>
                                        <li>
                                            <a href="login.php">Author Login</a>
                                        </li>
                                        <li>
                                            <a href="publog.php">Publisher Login</a>
                                        </li>
                                        <li>
                                            <a href="sign-up.php">Author Sign Up</a>
                                        </li>
                                        <li>
                                            <a href="sign-up-pub.php">Publisher Sign Up</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <span class="fa-comment ">Get In Touch</span>
                                    <ul>
                                        <li>
