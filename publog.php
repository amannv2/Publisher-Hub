...
?>
        ...
        <div id="content">
            <div class="container background-white">
                <div class="container">
                 <br />  <h2 class="text-center article-title"> Welcome Back, Publisher </h2> 
                    <div class="row margin-vert-30">
                        <!-- Login Box -->
                        <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                            <form class="login-page" method="POST" action="publogcheck.php">
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    ...
                                    <p><b> <a href="sign-up-pub.php">Click Here</a> to Sign Up<b></p>
                                    </div>
                                </div>
                            </form>
                        </div>
